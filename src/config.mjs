...
const CONFIG_FIELDS = [
  {
    key: "markdownInputDir",
    envKey: "MARKDOWN_INPUT_DIR",
    configKey: "markdownInputDir",
    path: true,
  },
  {
    key: "outputDir",
  ...
  {
    key: "outputCssFile",
    envKey: "OUTPUT_CSS_FILE",
    configKey: "outputCssFile",
    path: true,
  },
  {
    key: "tailwindInputCss",
    envKey: "TAILWIND_INPUT_CSS",
    configKey: "tailwindInputCss",
    path: true,
  },
  {
    key: "headerTemplatePath",
    envKey: "HEADER_TEMPLATE_PATH",
    configKey: "headerTemplatePath",
    path: true,
    cliKey: "headerTemplatePath",
  },
  {
    key: "footerTemplatePath",
    envKey: "FOOTER_TEMPLATE_PATH",
    configKey: "footerTemplatePath",
    path: true,
    cliKey: "footerTemplatePath",
  },
  {
    key: "documentTemplatePath",
    envKey: "DOCUMENT_TEMPLATE_PATH",
    configKey: "documentTemplatePath",
    path: true,
    cliKey: "documentTemplatePath",
  },
  {
    key: "bookLayoutCssPath",
    envKey: "BOOK_LAYOUT_CSS_PATH",
  ...
  },
  {
    ...
    envKey: "REMARKABLE_UPLOAD_ENABLED",
    configKey: "remarkableUploadEnabled",
    parser: (value) => parseBoolean(value, "REMARKABLE_UPLOAD_ENABLED"),
  },
  {
    key: "remarkableHost",
    envKey: "REMARKABLE_HOST",
    configKey: "remarkableHost",
  },
  {
    key: "remarkableXochitlDir",
    envKey: "REMARKABLE_XOCHITL_DIR",
    configKey: "remarkableXochitlDir",
  },
  {
    key: "remarkableParentFolderUuid",
    envKey: "REMARKABLE_PARENT_FOLDER_UUID",
    configKey: "remarkableParentFolderUuid",
  },
  {
    key: "remarkableParentFolderName",
    envKey: "REMARKABLE_PARENT_FOLDER_NAME",
    configKey: "remarkableParentFolderName",
  },
  {
    key: "sshUploadEnabled",
    envKey: "SSH_UPLOAD_ENABLED",
    configKey: "sshUploadEnabled",
    parser: (value) => parseBoolean(value, "SSH_UPLOAD_ENABLED"),
  },
  { key: "sshTarget", envKey: "SSH_TARGET", configKey: "sshTarget" },
  { key: "sshTargetDir", envKey: "SSH_TARGET_DIR", configKey: "sshTargetDir" },
  {
    key: "sshUploadMethod",
    envKey: "SSH_UPLOAD_METHOD",
    configKey: "sshUploadMethod",
    parser: (value) => String(value).toLowerCase(),
  },
  {
    key: "sshPort",
    envKey: "SSH_PORT",
  ...
  {
    key: "pdfPrintReady",
    envKey: "PDF_PRINT_READY",
    configKey: "pdfPrintReady",
    cliKey: "printReady",
    parser: (value) => parseBoolean(value, "PDF_PRINT_READY"),
  },
  {
    key: "pdfBleed",
    envKey: "PDF_BLEED",
...
export async function loadConfig(
  ...
  const { data: configFile, loaded: configFileLoaded } =
  ...
  if (!/^\d+(?:\.\d+)?(?:mm|cm|in|px)$/.test(String(config.pdfBleed).trim())) {
    throw new Error(
      "PDF_BLEED must be a CSS length like 3mm, 0.125in, 10px, or 0cm.",
    );
  }
